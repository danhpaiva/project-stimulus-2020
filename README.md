...
Trabalhamos conceitos importantes dentro da aplicação: lógica de programação, conexão com banco de dados na nuvem, consumo de dados através de uma API.<br>
