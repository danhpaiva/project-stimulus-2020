...
import 'package:stimulus/pages/mentoria/mentoria_especifica_05.dart';
      ...
      body: ListView(
        children: [
          Container(
            ...
            height: 100,
            child: Image.asset('assets/mapeamento_page04.png'),
          ),
          Container(
            margin: EdgeInsets.only(top: 20, left: 120, right: 120),
            child: Image.asset('assets/mapeamento_barra04.png'),
          ),
          Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MentoriaEspecificaPage05(),
                      ),
                    );
                  },
                  child: Text(
