...
import 'package:stimulus/pages/mentoria/mentoria_especifica_03.dart';
      ...
      body: ListView(
        children: [
          Container(
            ...
            height: 100,
            child: Image.asset('assets/mapeamento_page02.png'),
          ),
          Container(
            margin: EdgeInsets.only(top: 20, left: 120, right: 120),
            child: Image.asset('assets/mapeamento_barra02.png'),
          ),
          Container(
            margin: EdgeInsets.only(top: 10),
            child: Column(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MentoriaEspecificaPage03(),
                        ),
                      );
                    },
                    child: Text('Próxima',
