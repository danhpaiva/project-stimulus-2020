...
import 'package:stimulus/pages/mentoria/mentoria_especifica_sucesso.dart';
      ...
      body: ListView(
        children: [
          Container(
            ...
            height: 100,
            child: Image.asset('assets/mapeamento_page06.png'),
          ),
          Container(
            margin: EdgeInsets.only(top: 20, left: 120, right: 120),
            child: Image.asset('assets/mapeamento_barra06.png'),
          ),
          Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MentoriaEspecificaSucesso(),
                      ),
                    );
                  },
                  child: Text(
