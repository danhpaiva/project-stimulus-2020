...
import 'package:stimulus/pages/mentoria/mentoria_especifica_06.dart';
      ...
      body: ListView(
        children: [
          Container(
            ...
            height: 100,
            child: Image.asset('assets/mapeamento_page05.png'),
          ),
          Container(
            margin: EdgeInsets.only(top: 20, left: 120, right: 120),
            child: Image.asset('assets/mapeamento_barra05.png'),
          ),
          Container(
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MentoriaEspecificaPage06(),
                      ),
                    );
                  },
                  child: Text(
